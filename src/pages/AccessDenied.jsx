    ...
    <div className="relative min-h-screen overflow-hidden bg-[#05070B] text-[#F8FAFC] px-6 py-10">
      ...
      >
        ...
        <div className="space-y-3 text-center">
          <p className="text-xs uppercase tracking-[0.36em] text-[#7C93E4]">Access Denied</p>
          <h1 className="text-4xl font-semibold tracking-[-0.04em] text-[#F8FAFC]">
            You don't have access to this website
          </h1>
          <p className="mx-auto max-w-md text-sm leading-7 text-[#94A3B8]">
            To access Gapian AI, you need to purchase the product. Click the button below to get started.
          </p>
        </div>
